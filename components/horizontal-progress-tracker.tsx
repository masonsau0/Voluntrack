...
export function HorizontalProgressTracker({ completedHours, goalHours }: HorizontalProgressTrackerProps) {
  ...
  return (
    <div className="flex flex-col h-full relative overflow-hidden justify-center rounded-2xl" style={{ contain: "layout paint" }}>
      {/* Animated background starfield with parallax effect */}
      <div className="absolute inset-0 overflow-hidden pointer-events-none bg-[#1a365d]/10 rounded-2xl" style={{ contain: "strict", transform: "translateZ(0)" }}>
