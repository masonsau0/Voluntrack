...
const NEW_OPPORTUNITIES = [
    ...
    },
    {
        ...
        endTime: new Date("2026-05-10T14:00:00")
    },
    {
...
export default function SeedPage() {
        ...
        try {
            ...
            for (const oppData of NEW_OPPORTUNITIES) {
                try {
                    ...
                    stats.errors.push(`Failed to add "${oppData.title}": ${err.message}`);
                }
            }
    ...
    return (
        <div className="p-10">
            ...
            >
                Click to Seed Opportunities
            </button>

            {results && (
                <div className="mt-8 border p-4 rounded bg-gray-50">
                    <h2 className="font-bold mb-2">Results:</h2>
                    <p>Organizations Created: {results.organizationsCreated}</p>
                    <p>Opportunities Created: {results.opportunitiesCreated}</p>
